...
def update_worksheet(data, worksheet):
    """
    receives a list of integers to be inserted into worksheet and updates the relevant worksheet
    """
...
def get_last_5_entires_sales():
    """
    collects data from last 5 entries for each columnn-sandwich
...
def calculate_stock_data(data):
    ...
    for column in data:
        ...
        new_stock_data.append(round(stock_number))
